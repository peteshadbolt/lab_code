...
class dip_dialog:
	...
	def load_defaults(self):
		...
		self.dip_start_position.set(qy.settings.get('dip_start_position'))
		self.dip_stop_position.set(qy.settings.get('dip_stop_position'))
		self.dip_npoints.set(qy.settings.get('dip_npoints'))
		self.dip_nloops.set(qy.settings.get('dip_nloops'))
		self.dip_integration_time.set(qy.settings.get('dip_integration_time'))
		self.dip_motor_controller.set(qy.settings.get('dip_motor_controller'))
		self.dip_dont_move.set(int(qy.settings.get('dip_dont_move')))
		self.dip_close_shutter.set(int(qy.settings.get('dip_close_shutter')))
		self.default_label()
	...
	def save_defaults(self):
		...
		qy.settings.put('dip_start_position', self.dip_start_position.get())
		qy.settings.put('dip_stop_position', self.dip_stop_position.get())
		qy.settings.put('dip_npoints', self.dip_npoints.get())
		qy.settings.put('dip_nloops', self.dip_nloops.get())
		qy.settings.put('dip_integration_time', self.dip_integration_time.get())
		qy.settings.put('dip_motor_controller', self.dip_motor_controller.get())
		qy.settings.put('dip_dont_move', int(self.dip_dont_move.get()))
		qy.settings.put('dip_close_shutter', int(self.dip_close_shutter.get()))
	...
	def build(self):
		...
		options=map(str, range(1, 1+int(qy.settings.get('motors_count'))))
